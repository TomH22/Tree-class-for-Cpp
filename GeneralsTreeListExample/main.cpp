...
int main(int, char**)
{
    ...
    ::RegisterClassEx(&wc);
    HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("Generals tree list example"), WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, NULL, NULL, wc.hInstance, NULL);
    ...
    while (!done)
    {
		...
		{
			ImGui::Begin("List");
			auto i = make_shared<StaffTopDownIterator>(treeModel, bOrderAlphabetical, bShowStaffSergants, bShowSergants, bShowCorporals, bShowPrivates);
